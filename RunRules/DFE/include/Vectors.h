...
typedef struct { 
	...
	const float *instream_inVector1; /**<  [in] The stream should be of size ((param_N * 4) * 8) bytes. */
	const float *instream_inVector2; /**<  [in] The stream should be of size ((param_N * 4) * 8) bytes. */
	float *outstream_outVector; /**<  [out] The stream should be of size ((param_N * 4) * 8) bytes. */
} Vectors_actions_t;
